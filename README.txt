## ----------------------------------------------------------------------------
##    README File for GMM Training using Multiprocessing on Large Datasets
##    Copyright (C) 2014,  D S Pavan Kumar
## ----------------------------------------------------------------------------

*) The script trains diagonal covariance GMMs on large datasets using Expectation Maximisation (EM) algorithm.
